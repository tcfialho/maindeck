...
- [x] **6.** **P1.1** — Refatorar o array de toplevels da taskbar ([bar-taskbar.c](file:///home/tcfialho/Documents/poc/maindeck-wm/bar-taskbar.c)) para slots estáveis (ponteiros alocados via calloc) para evitar ponteiros corrompidos após `memmove`.
...
- [x] **11.** **P3.2** — Cachear `PangoLayout` por toplevel (taskbar) e para o relógio na barra ([bar-render.c](file:///home/tcfialho/Documents/poc/maindeck-wm/bar-render.c)).
...
- [x] **14.** **P3.3d** — Implementar cache serializado em disco (`~/.cache/maindeck/apps.cache`) para o menu.
